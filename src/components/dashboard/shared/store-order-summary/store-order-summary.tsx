...
import ProductStatusSelect from "@/components/dashboard/forms/product-status-select/product-status-select";
          ...
          >
            ...
            <div className="flex flex-col gap-y-1">
              ...
              <div className="text-sm">
                <p className="font-normal text-gray-500">
                  Discount:
                  <span className="ms-1">${discountedAmount.toFixed(2)}</span>
                </p>
              </div>
            </div>
