...
import { OrderProductRowProps } from "@/components/store/order-page/order-product-row/order-product-row.types";

export default function ProductRow({ product }: OrderProductRowProps) {
  return (
    <div className="flex flex-col lg:flex-row items-center py-6 gap-6 w-full">
      <div className="max-lg:w-full">
        <Image
          src={product.image}
          alt={product.variantId}
          width={200}
          height={200}
