...
import { PaymentTableDateFilter } from "@/types/payment.types";
import { ReviewFilter } from "@/types/review.types";
import { cn } from "@/lib/utils";

import { ReviewsHeaderProps } from "@/components/store/profile/reviews/reviews-header/reviews-header.types";

const ReviewsHeader: FC<ReviewsHeaderProps> = ({
  filter,
  setFilter,
  search,
  setSearch,
