...
export const ProductFormSchema = z.object({
  ...
  // seoTitle: z
  //   .string({
  //     required_error: "SEO Product title is mandatory.",
  //     invalid_type_error: "SEO Product title must be a valid string.",
  //   })
  //   .optional(),
  // .min(200, {
  //   message: "SEO Product title should be at least 200 characters long.",
  // }),
  // seoDescription: z
  //   .string({
  //     required_error: "SEO Product description is mandatory.",
  //     invalid_type_error: "SEO Product description must be a valid string.",
  //   })
  //   .optional(),
  // .min(200, {
  //   message: "SEO Product description should be at least 200 characters long.",
  // }),
  colors: z
